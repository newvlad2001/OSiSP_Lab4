...
#define ZERO_PID_FILE "./tmp/zero_pid.txt"
#define FIRST_PID_FILE "./tmp/first_pid.txt"
#define SECOND_PID_FILE "./tmp/second_pid.txt"
#define THIRD_PID_FILE "./tmp/third_pid.txt"
#define FOURTH_PID_FILE "./tmp/fourth_pid.txt"
#define FIFTH_PID_FILE "./tmp/fifth_pid.txt"
#define SIXTH_PID_FILE "./tmp/sixth_pid.txt"
#define SEVENTH_PID_FILE "./tmp/seventh_pid.txt"
#define EIGHTH_PID_FILE "./tmp/eighth_pid.txt"
...
void second_usr2_handler(int sig_num) {
    ready3 = 1;
}

void third_usr2_handler(int sig_num) {
    ready4 = 1;
}

void fifth_usr2_handler(int sig_num) {
    ready6 = 1;
}

void eighth_usr2_handler(int sig_num) {
    ready7 = 1;
}
...
void init_eighth_proc() {
    ...
    init_action(SIGUSR2, eighth_usr2_handler);
...
void init_fifth_proc() {
    ...
    init_action(SIGUSR2, fifth_usr2_handler);
...
void init_third_proc() {
    ...
    init_action(SIGUSR1, third_usr2_handler);
...
void init_second_proc() {
    ...
    init_action(SIGUSR1, second_usr2_handler);
